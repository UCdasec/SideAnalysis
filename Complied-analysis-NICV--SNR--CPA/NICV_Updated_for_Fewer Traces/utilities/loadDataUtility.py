...
def data_info(data_matrix):
    ...
    """
    try:
        power_traces, plain_text, key = data_matrix['trace_mat'], data_matrix['textin_mat'], data_matrix['key']
    except:
        power_traces, plain_text, key = data_matrix['power_trace'], data_matrix['plain_text'], data_matrix['key']
